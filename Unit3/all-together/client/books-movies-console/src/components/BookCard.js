        ...
        <div>
            <div class="card">
                <h2>
                  ...
                  <Link  class="mainlink" to={`/show-book/${bookInfo.title}`} replace>
                      { bookInfo.title }
                  </Link>
                </h2>
                ...
                <Link class="sublink" to={`/update-book/${bookInfo._id}`} state={bookInfo}>
                    Update
                </Link>
                <Link class="sublink" to={`/delete-book/${bookInfo._id}`} state={bookInfo}>
                    Delete
                </Link>
            </div>
        </div>
